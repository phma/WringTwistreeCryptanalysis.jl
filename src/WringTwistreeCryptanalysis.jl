...
function allSmallDiffs()
  smallDiffs(wring96_0,"96_0")
  smallDiffs(wring96_1,"96_1")
  smallDiffs(wring96_2,"96_2")
  smallDiffs(wring96_3,"96_3")
  smallDiffs(wring30_0,"30_0")
  smallDiffs(wring30_1,"30_1")
  smallDiffs(wring30_2,"30_2")
  smallDiffs(wring30_3,"30_3")
  smallDiffs(wring6_0,"6_0")
  smallDiffs(wring6_1,"6_1")
  smallDiffs(wring6_2,"6_2")
  smallDiffs(wring6_3,"6_3")
  smallDiffs(WringTwistree.linearWring,"linear")
  smallDiffs(WringTwistree.tripleTwistWring,"3twist")
  smallDiffs(WringTwistree.tripleTwist69Wring,"3twist69")
end
...
function readSmallDiffs(file::IO)
  ret=OffsetMatrix(fill(OffsetMatrix([NaN;;],-1,-1),25,3),2,0)
  while !eof(file)
    (bytes,nrond,diffs)=readDiffs1(file)
